...
//
//		TextureDescriptor1			= DescriptorPool->AllocateDescriptorHandle(EDescriptorType::Texture);
//		TextureDescriptor1.Resource = Texture.Get();
//		DescriptorPool->UpdateDescriptor(TextureDescriptor1);
//
//		TextureDescriptor2			= DescriptorPool->AllocateDescriptorHandle(EDescriptorType::Texture);
//		TextureDescriptor2.Resource = Texture.Get();
//		DescriptorPool->UpdateDescriptor(TextureDescriptor2);
//	}
//
//	void InitScene()
//	{
