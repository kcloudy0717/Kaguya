...
/* 
* TODO:
* 1. Add HDRI rendering, and potentially modify the environment color in constant buffer instead or just add a environment cubemap
...
#define BEDROOM_SCENE 0
	...
	rayPayload.L += rayPayload.beta * lerp(float3(1.0, 1.0, 1.0), float3(0.5, 0.7, 1.0), t) * 5.0f;
#endif
